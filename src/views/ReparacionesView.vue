<template>
    <div class="row main">
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="btn-group my-3" role="group">
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="cambiarPestania('datosCliente')"
                    >
                        Datos Cliente
                    </button>
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="cambiarPestania('reparacion')"
                    >
                        Reparacion
                    </button>
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="cambiarPestania('historial')"
                    >
                        Datos de Taller
                    </button>
            ...
            <div class="col">
                <BotonesCrud
                    @crear="crear(reparacion)"
                    @eliminar="eliminar(reparacion.id)"
                    @modificar="modificar(reparacion)"
                    :is-cliente="!!reparacion.id"
                    text="Crear la Reparación"
                />
            </div>
        </div>
                    ...
                    <div class="col col-lg-4">
                        ...
                        <div class="mt-3">
                            <VueMultiselect
                                ...
                                :options="clientes"
                                :close-on-select="true"
                                placeholder="Intente buscar un Cliente"
                                label="nombre"
                                track-by="id"
                                data-select="Seleccione Una opcion"
                                :disabled="!isNew"
