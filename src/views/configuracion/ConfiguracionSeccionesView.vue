<template>
                ...
                <div class="card" style="width: 100%">
                    ...
                    <div class="card-body">
                        <div class="col col-6">
                            ...
                            <input
                                type="text"
                                class="d-flex form-control form-control-md text-uppercase"
                        ...
                        <div class="row">
                            <div class="col col-5 mt-3 offset-">
                                <a @click="eliminar(item.id, index)" class="btn btn-danger"
                                    ><font-awesome-icon icon="trash-can" /> Eliminar</a
                                >
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-3">
        <button class="btn btn-info w-100 mt-3 text-uppercase" @click="agregarSeccion()">
            <font-awesome-icon icon="plus" /> Agregar
        </button>

        <button class="btn btn-warning w-100 mt-3 text-uppercase" @click="modificar(secciones)">
            <font-awesome-icon icon="pen-ruler" /> modificar secciones
        </button>
    </div>
</template>
