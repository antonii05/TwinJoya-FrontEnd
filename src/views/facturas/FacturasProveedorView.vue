    ...
    <div class="container-fluid">
        <div>
            <CardComponent size="col-5">
                ...
                <h6>Meter Informacion del empleaado que le ha dado de alta</h6> </CardComponent
            ><br />
            <br />
        </div>
        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="btn-group my-3" role="group">
                    <button type="button" class="btn btn-info" @click="cambiarPestania('cabecera')">
                        Cabecera
                    </button>
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="cambiarPestania('otrosCostes')"
                    >
                        Otros Costes
                    </button>

                    <button type="button" class="btn btn-info" @click="cambiarPestania('lineas')">
                        Lineas
                    </button>
                    <button type="button" class="btn btn-info" @click="cambiarPestania('pie')">
                        Pie
                    </button>
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="cambiarPestania('vencimientos')"
                    >
                        Vencimientos
                    </button>
                </div>
            ...
            <div class="col">
                <BotonesCrud
                    :is-cliente="!!facturaProveedor.numero_factura"
                    @crear="crear(facturaProveedor)"
                    @eliminar="eliminar(facturaProveedor.numero_factura)"
                    @modificar="update(facturaProveedor)"
                    text="Crear Factura"
                />
            </div>
        </div>
        ...
        <CardComponent style="z-index: 1">
            <div class="row">
                ...
                <div class="col col-lg-4">
                    ...
                    <div class="mt-3">
                        <VueMultiselect
                            v-model="facturaProveedor.empresa"
                            :options="empresas"
                ...
                <div class="col col-lg-4 text-center justify-content-center d-flex">
                    <div class="row">
                        ...
                        <input
                            ...
                            v-model="facturaProveedor.fecha_recepcion"
                            :disabled="!isNew"
                        />
                    </div>
                </div>
                ...
                <div class="col col-lg-4">
                    ...
                    <div class="mt-3">
                        <VueMultiselect
                            v-model="facturaProveedor.proveedor"
                            :options="proveedores"
                            :close-on-select="true"
