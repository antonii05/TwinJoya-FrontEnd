                ...
                <div class="sidebar col-lg-1 p-0 l-navbar">
                    ...
                    >
                        ...
                        <div class="offcanvas-body d-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                            <ul
                                class="nav nav-flush flex-column text-center align-items-start ms-2"
                            >
                                <li>
                                ...
                                <li class="m-1">
                                    <button
                                        class="btn btn-toggle fw-bold text-capitalize collapsed"
                                    ...
                                    <div class="collapse" id="dashboard-collapse1">
                                        <ul
                                            class="btn-toggle-nav list-unstyled fw-normal pb-1 small text-start"
                                        >
                                            <li class="mt-2">
                                                <a
                                            ...
                                            <li class="mt-2">
                                                <a
                                                    ...
                                                    @click="
                                                        $router.push(
                                                            '/configuracion/familias/config/adicional',
                                                        )
                                                    "
                                                >
                                                    <font-awesome-icon
                                                        ...
                                                        class="me-2"
                                                    />
                                                    Configuración Adicional Familias
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="m-1">
                                    ...
                                    <div class="collapse" id="dashboard-collapse2">
                                        ...
                                        >
                                            <li
                                                class="mt-2"
                                                @click="$router.push('/facturas/proveedores')"
                                            >
