            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 text-md-end mt-3 mt-md-0">
                    <button
                        type="button"
                        class="btn btn-info"
                        @click="aniadirLinea(facturaProveedor)"
                    >
                        Añadir Articulo
                    </button>
                </div>
                ...
                <table class="table table-info table-striped">
                    ...
                    <tbody>
                        <tr v-for="(linea, index) in facturaProveedor.lineas" :key="index">
                            ...
                            <td>
                                <div class="col">
                                    <input
                                        ...
                                        class="text-start"
                                        placeholder="Busque el codigo de un articulo"
                                    />
                                </div>
                            </td>
                            <td>
                            ...
                            <td
                                class="text-center"
                                @click="eliminarFila(facturaProveedor.lineas, index)"
                            >
...
import type { LineaProveedor } from '@/models/LineaProveedor';
