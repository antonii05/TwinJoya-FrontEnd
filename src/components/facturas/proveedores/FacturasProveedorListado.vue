    ...
    <div class="px-5" v-if="facturasProveedor">
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 col order-lg-1">
                <div class="input-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        id="busqueda_1"
                        placeholder="Busca una factura por su numero"
                        @keyup.enter="buscar('busqueda_1')"
                    />
                </div>
            </div>
            <div class="col-lg-8 col order-lg-2">
                <button
                    ...
                    @click="$router.push('/facturas/proveedores/nuevo')"
                >
                    Nueva Factura
                </button>
            </div>
        ...
        <CardComponent>
            <table class="table">
                ...
                <tr
                    class="filas"
                    v-for="(item, index) in facturasProveedor"
                    :key="index"
