...
export default {
    ...
    async buscarFactura(cadena: string) {
        return axios
            .get('/facturasProveedor/buscar/?cadena=' + cadena)
            .then((response: AxiosResponse) => {
                return response.data;
            })
            .catch((error: AxiosError) => {
    ...
    async crear(facturaProveedor: FacturasProveedor) {
        return axios
            .post('/facturasProveedor/crear', facturaProveedor)
            .then((response: AxiosResponse) => {
                return response.data;
            })
            .catch((error: AxiosError) => {
    ...
    async update(facturaProveedor: FacturasProveedor) {
        return axios
            .put('/facturasProveedor/update', facturaProveedor)
            .then((response: AxiosResponse) => {
                return response.data;
            })
            .catch((error: AxiosError) => {
    ...
    async delete(numero_factura: number) {
        return axios
            .delete('/facturasProveedor/delete/' + numero_factura)
            .then((response: AxiosResponse) => {
                return response.data;
            })
            .catch((error: AxiosError) => {
